            ...
            <div className="info-scroll" ref={containerRef}>
              ...
              <div className="info-section info-welcome">
                ...
                <p className="info-body">
                  ...
                  Η εφαρμογή λειτουργεί ως σημείο εισόδου στο ερευνητικό υλικό και 
                  στην ψηφιακή ανασύσταση τμημάτων της πόλης πριν από την εφαρμογή 
                  του πολεοδομικού σχεδίου του 1925.
                </p>
              ...
              <div ref={aboutRef} className="info-section">
                ...
                <p className="info-body">
                  ...
                  ιστορικής μορφής της οδού Μεραρχίας στις Σέρρες. Μέσα από τη συνδυαστική 
                  ανάλυση ιστορικών χαρτών, φωτογραφιών και αρχειακού υλικού, επιχειρείται 
                  η ανασύσταση ενός αστικού τοπίου που δεν είναι πλέον ορατό στη σημερινή πόλη.
                  Η εφαρμογή λειτουργεί ως ψηφιακό αποθετήριο και εργαλείο εξερεύνησης του υλικού, 
                  με στόχο την κατανόηση της ιστορικής συνέχειας και της μεταβολής του αστικού χώρου.
                </p>
              </div>
